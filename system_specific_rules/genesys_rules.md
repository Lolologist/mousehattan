# **The Great Burrow - Genesys RPG Rules**
...
- **Special Abilities:**
  ...
  - **Survivor's Instinct:** Add ⬜ to Vigilance and Cool checks
...
- **Special Abilities:**
  ...
  - **Scavenger:** Add ⬜ to Survival checks to find resources
  - **Nocturnal:** Remove ⬛ from checks made in darkness
...
- **Starting XP:** 100
- **Special Abilities:**
  - **Dexterous Paws:** Add ⬜ to Skulduggery and Mechanics checks
...
Choose one burrow. Remove ⬛ from all social and navigation checks in that burrow. Add ⬜ to Streetwise checks related to that burrow's culture and politics.

#### **Species Solidarity** *(Passive)*
Add ⬜ to social checks when interacting with creatures of the same species. This bonus increases to ⬜⬜ when dealing with family or clan members.

#### **Tunnel Fighter** *(Passive)*
When fighting in confined spaces (tunnels, burrows, etc.), add ⬜ to combat checks and increase defense by 1.

#### **Predator Awareness** *(Passive)*
Add ⬜ to Vigilance checks to detect aerial predators. When a predator is spotted, may spend 1 strain to immediately move to cover as an out-of-turn incidental.

#### **Union Member** *(Passive)*
Gain access to union resources, legal aid, and worker solidarity. Add ⬜ to social checks with other union members. Reduce cost of certain services by 25%.

### **Tier 2 Talents**

#### **Crime Family Connected** *(Passive)*
Gain protection and resources from organized crime, but also obligations. Add ⬜⬜ to Streetwise checks in criminal contexts. Reduce difficulty of acquiring illegal goods by 1.

#### **Titan Survivor** *(Passive)*
Having survived a direct titan encounter, add ⬜ to all checks related to giant creatures. Other creatures treat you with respect/fear. Once per session, may add ⬜⬜ to a Cool or Discipline check.
...
#### **Burrow Boss** *(Passive)*
Leadership position in burrow hierarchy. Add ⬜⬜ to Leadership checks. Can call upon significant resources and followers. Gain political influence but also enemies.

#### **Ranger Elite** *(Passive)*
Veteran of multiple titan encounters. Add ⬜⬜ to all combat checks against large creatures. Gain access to advanced Ranger equipment and tactics.
...
- **Surprise Attacks:** Predators get ⬜⬜ on initial attack if creatures are in open
...
- **Political:** Burrow autonomy vs. city unity, democratic vs. authoritarian
- **Personal:** Family obligations vs. individual dreams

### **Success Metrics**
Success in The Great Burrow isn't just about individual achievement, but about strengthening community bonds, protecting vulnerable creatures, and building a better city for everyone. Measure success by:
...
- **Collective Prosperity:** Ensuring benefits reach all creatures, not just elites
