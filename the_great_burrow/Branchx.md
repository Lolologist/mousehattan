...
- **Branch Levels**: Roughly seven distinct heights, from "Ground Scrape" to "Crown Touch"
...
- **Hollow Expansions**: Carved deeper into living wood over generations
...
### **Transportation**
- **The Great Underground**: Two stations, Deep Root and Grove Junction
- **Rope Bridges**: From sturdy cargo crossings to terrifying thread-thin shortcuts
- **Branch Running**: Skilled creatures race along highways
- **Zip Lines**: Bark-fiber cables for rapid descent (climbing back is harder)
- **Gliding**: Flying squirrels operate premium transport service
...
- **Decoy Nests**: Abandoned structures to distract predators
...
- **Weather Awareness**: Clear days mean maximum danger
...
#### **High Branch Elite**
- **The Acorn Lords**: Families controlling prime territories
- **Bridge Barons**: Who built and maintain major crossings
- **The Old Nests**: Generational wealth in hollows
- **Winter Cache Dynasties**: Those who never go hungry

#### **Working Branches**
- **Construction Crews**: Building and maintaining the canopy city
- **Courier Collectives**: Chipmunk-dominated message services
- **Bridge Minders**: Toll collectors and maintenance
- **Branch Runners**: Professional racers and guides
- **Rope Weavers**: Essential craft passed through families

#### **The Scraping By**
- **Ground Proximals**: Too poor for higher branches
- **Seasonal Workers**: Hired for construction or harvest
- **The Nestless**: Sleeping in communal shelters
- **New Arrivals**: Earning their way up the tree
- **Gang Runners**: Young creatures in crow-affiliated groups
...
### **The Acorn Economy**
- **Territory Rights**: Who harvests which branches
- **Processing**: Different preparation methods add value
- **Storage Wars**: Cache security is big business
- **Seasonal Labor**: Harvest time needs every paw
- **Acorn Futures**: Speculation causes price swings
...
- Not just labor - includes "muscle" for disputes
- Controls who works construction
- "Break more than nuts" reputation
- Protection for members extends to families
- Bitter rivalry with scab operators

### **The Tailwind Gang**
- Chipmunk-dominated courier collective
- Controls prime message routes
- Races are both sport and territory marking
...
- Ancient feuds over territory and honor
- Marriage alliances shift power constantly
...
- **Lunch Branches**: Social hour on designated limbs
- **Sunset Scramble**: Racing darkness home
- **Night Shift**: Dangerous but better paid

### **Social Customs**
- **Tail Flags**: Complex signaling system
- **Branch Drumming**: Rhythmic communication
- **Grooming Circles**: Social bonding and politics
- **Nut Gifting**: Courtship and respect
- **Height Deference**: Higher branch = right of way

### **Food Culture**
- **Acorn Everything**: 67 traditional preparations
- **Bark Tea**: Mild stimulant for workers
- **Seed Cakes**: Portable energy for couriers
- **Fermented Sap**: The working creature's drink
- **Communal Roasts**: Neighborhood gatherings

### **Survival Skills**
- **Predator Drills**: Weekly for kits
- **Bridge Testing**: Never trust, always check
- **Weather Reading**: Storms mean death above
- **Cache Security**: Hiding places passed to offspring
- **Emergency Signals**: Every creature knows alarm calls
...
### **Social Venues**
- **The Knothole**: Roughest bar in the canopy
- **Acorn Cap**: Working-class social club
- **The Racing Branch**: Courier competition venue
- **Tail's End**: Where old squirrels tell stories
...
### **Traditions**
- **First Climb**: Kit's ceremonial ascent
- **The Harvest Dance**: Celebrating acorn season
- **Bridge Day**: Honoring builders and minders
- **Tail Festival**: Showing off grooming and strength
- **Dawn Whistle**: Starting work together

### **Superstitions**
- Never cross under a crow's shadow
- Tap branch three times before climbing
- First acorn of season brings luck
- Shed fur in nest prevents falls
- Whistle while climbing attracts hawks

### **Class Markers**
- Branch height indicates status
- Tail grooming shows leisure time
- Claw wear reveals manual labor
- Nest materials display wealth
- Bridge access demonstrates connections
...
- Mousehattan money buying tree rights
- Traditional families forced lower
- "Authentic canopy experience" tourism
- New construction ignoring safety traditions
- Cultural erosion for profit
...
### **Gang Violence**
- Territory wars escalating
- Young creatures joining for protection
- Crow affiliations complicating loyalties
- Drug trade (fermented sap variants)
...
### **Working-Class Drama**
- Strike breaking leads to violence
- Young squirrel forced between union and gang
- Bridge collapse investigation reveals corruption
- Family losing branch rights to debt
...
- Crow gang demanding higher tribute
- Storm damage creating refugee crisis
- Predator using new hunting technique

### **Cultural Conflicts**
- Traditional family feuding with gentrifiers
- Young creatures rejecting height hierarchy
- Cross-species romance causing scandal
- Ancient acorn rights disputed
...
### **Mousehattan**
- Love/hate with their money
- Many commute for construction work
- Resentment over gentrification
- "Soft-pawed acorn counters"

### **Lin's Brook**
- Working-class solidarity
- Compete for construction contracts
- Share union organizing strategies
- "Water workers get it"

### **The Hives**
- Trade partnerships for different goods
- Respect for different skills
- Some marriage connections
- "Ground dwellers but good ones"

### **Scurry Island**
- Where troublemakers flee
- Black market connections
- Shared outsider status
- "Even they made it out"
...
- Vertical expansion reaching dangerous heights
- New tree cultivation changing landscape
- Technology promises (all failing)
- Outside investment destroying community

### **Cultural Evolution**
- Youth questioning height hierarchy
- Inter-species integration increasing
- Traditional skills being lost
- Pride competing with survival

### **Environmental Changes**
- Storms increasing in severity
- Predator patterns shifting
- Trees showing stress signs
- Climate affecting acorn yields
