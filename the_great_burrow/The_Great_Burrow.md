# **The Great Burrow - A Complete Guide**

## **Welcome to the Forest Metropolis**

In the heart of an ancient mixed hardwood forest, where massive oaks drop their bounty and maples paint autumn gold, lies The Great Burrow - a sprawling metropolis of woodland creatures that rivals any great city in scope, ambition, and complexity. Here, five distinct boroughs pulse with life, connected by the engineering marvel of the Great Underground subway system, divided by the East and West Rivers, and united in their constant vigilance against the titans that walk the earth.

This is a city where squirrels build rope bridges between skyscrapers of bark and leaf, where beaver-engineered dams power workshops that never sleep, where organized crime families of rats control the waterfront while mice cling to old money and older traditions. It's a place where your species, your borough, and your branch height determine your destiny - unless you're clever enough, tough enough, or desperate enough to change it.
...
The marvel of mole engineering, this subway system connects all five boroughs through natural tunnels, hollow logs, and carved passages. Express routes follow main arteries while local service winds through neighborhoods. Stations include:
...
- **Rope Bridges**: Spanning gaps in the canopy
- **Ferry Services**: Crossing the rivers (when operational)
- **Courier Networks**: Chipmunks and flying squirrels for messages
- **Private Options**: From otter swimming services to bat flights

### **Communication**
- **Tail Signals**: Universal basic communication
- **Scent Marking**: Territory and status indicators
- **Drumming Networks**: Branch or ground percussion for alerts
...
### **Currency & Trade**
- **Acorn Standard**: Basic currency, valued by quality and preparation
- **Commodity Markets**: Seeds, nuts, berries, mushrooms
- **Seasonal Fluctuations**: Harvest times drive booms and busts
- **The Acorn Exchange**: Central trading floor in Mousehattan
- **Barter Systems**: Still common in outer boroughs

### **Major Industries**
- **Finance**: Centered in Mousehattan
- **Construction**: The Branchx and Lin's Brook specialties
- **Agriculture**: The Hives' managed insect operations
- **Fishing**: Lin's Brook's waterfront economy
- **Black Market**: Scurry Island's shadow economy

### **Labor & Unions**
- **The Nutcracker Union**: Powerful Branchx construction organization
- **Dockworkers United**: Lin's Brook's waterfront muscle
...
- **Borough Guards**: Varying effectiveness and corruption
...
- **Summer**: Tourism peaks, drought stresses water boroughs
- **Fall**: Harvest determines winter survival, preparation crucial
- **Winter**: Food politics dominate, heating becomes currency

### **Universal Experiences**
- **The Underground Commute**: Packed tunnels, frequent delays
- **Predator Drills**: Every kit knows the alarm signals
- **Market Days**: Borough specialties draw cross-city traffic
- **Weather Watching**: Storms mean infrastructure danger
- **Giant Protocols**: When bells ring, everyone knows what to do

---

## **Playing in The Great Burrow**

### **Adventure Themes**
- **Urban Survival**: Making it in the big city with predators above and poverty below
- **Political Intrigue**: Borough politics, union organizing, crime family wars
- **Economic Ambition**: Rising from nothing to something in the acorn economy
- **Cultural Exploration**: Navigating the complex societies of five distinct boroughs
- **Heroic Defense**: Rangers facing titans, creatures protecting communities

### **Character Concepts**
- **The Climber**: Ambitious creature seeking to rise above their station
- **The Fixer**: Connected to multiple boroughs, solving problems
- **The Ranger**: Protecting civilization from titan threats
- **The Revolutionary**: Fighting gentrification and inequality
- **The Survivor**: Using street smarts to navigate urban dangers

### **Conflict Sources**
- **Internal**: Borough tensions, crime wars, labor disputes
- **External**: Titan threats, predator attacks, weather disasters
- **Personal**: Family obligations vs. ambition, tradition vs. progress
- **Economic**: Boom and bust cycles, gentrification pressure
- **Environmental**: Infrastructure decay, climate change impacts
